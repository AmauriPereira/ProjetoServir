...
public class GestaoAlunoTela1JInternalFrame extends javax.swing.JInternalFrame {
    ...
    static PessoaRepositorio pessoas = new PessoaDAO();
    ...
    private void initComponents() {
        ...
        cmbEstado.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione um estado:", "Acre", "Alagoas", "Amapá", "Amazonas", "Bahia", "Ceará", "Distrito Federal", "Espírito Santo", "Goiás", "Maranhão", "Mato Grosso", "Mato Grosso do Sul", "Minas Gerais", "Pará", "Paraíba", "Paraná", "Pernambuco", "Piauí", "Rio de Janeiro", "Rio Grande do Norte", "Rio Grande do Sul", "Rondônia", "Roraima", "Santa Catarina", "São Paulo", "Sergipe", "Tocantins" }));
    ...
    private void btnAddBairroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddBairroActionPerformed
        ...
        this.populaCmbBairro();
        CadastroBairroJFrame cadastroBairroJInternalFrame = new CadastroBairroJFrame();
    ...
    private void btnAvancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvancarActionPerformed
        dadosFormularioCadastraAluno();
        GestaoAlunoTela2JInternalFrame gestaoAlunoTela2JInternalFrame = new GestaoAlunoTela2JInternalFrame(this.painelPrincipal,aluno);
