 ...
 */
public class CadastroDeficienciaJInternalFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form CadastroDeficienciaJInternalFrame
     */
    public CadastroDeficienciaJInternalFrame() {
        initComponents();
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            deficiencia.setNome(nome);
            DeficienciaRepositorio deficiencias = new DeficienciaDAO();
            deficiencias.salvar(deficiencia);
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        if (JOptionPane.showConfirmDialog(null, "Deseja realmente cancelar?", "Cadastro Deficiência", JOptionPane.YES_NO_OPTION) == 0) {
            this.dispose();
        }
