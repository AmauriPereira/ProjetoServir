 ...
 */
public class CadastroBairroJInternalFrame extends javax.swing.JInternalFrame {
     ...
     */
    public CadastroBairroJInternalFrame(JDesktopPane painelPrincipal) {
        initComponents();
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cadastro realizado com sucesso!", "Cadastro de Bairro", JOptionPane.OK_OPTION);
            this.dispose();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Não foi possivel realizar o cadastro!", "Cadastro Bairro", JOptionPane.ERROR_MESSAGE);
